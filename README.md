...
We are using a TURN and STUN server in our Kerberos Enterprise Suite offering to connect Kerberos Agents, living at the edge, to a remote Kerberos Hub. Livestreams are being forwarded from the edge to the cloud using WebRTC, and therefore relevant services such as TURN and STUN.
